export default function ClockSVG({classes}:{classes: string | undefined})
{
    return (
        ...
        <path d="M6 19L4 21" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
        <path d="M18 19L20 21" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
