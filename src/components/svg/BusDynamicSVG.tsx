...
{
    return (
        <div style={{backgroundColor: `#${"fff"}`, border: `2px solid #${color}`}}
             className="flex flex-col items-center shadow rounded-md bg-white w-fit aspect-square p-1 pr-1.5 pl-1.5">
            <svg className={className} width="18px" height="18px" viewBox="0 0 24 24" fill="none"
            ...
            <Label style={{color: `#${"#000"}`}}>{text}</Label>
        </div>
    )
}